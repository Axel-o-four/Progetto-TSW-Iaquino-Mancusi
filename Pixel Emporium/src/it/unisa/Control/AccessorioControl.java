...
import it.unisa.Model.ConsoleModelDS;import it.unisa.Model.AccessorioBean;
...
public class AccessorioControl extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
	    ...
	    if ("search".equalsIgnoreCase(action)) {
	        ...
	        Collection<AccessorioBean> risultati;
	        try {
            ...
            if (action != null) {
                if (action.equalsIgnoreCase("addC")) {
                    ...
                    return;
                	  ...
                	  int id = Integer.parseInt(request.getParameter("id"));
                	  AccessorioBean bean = model.doRetrieveByKey(id);
                	  request.setAttribute("accessorio", bean);
                	  RequestDispatcher rd = request.getRequestDispatcher("/admin/AccessorioForm.jsp");
                    ...
                    String type        = request.getParameter("accessoryType");
