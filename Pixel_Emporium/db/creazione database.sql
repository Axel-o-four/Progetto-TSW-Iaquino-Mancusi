...
CREATE TABLE DETTAGLIO_ORDINE (
    ...
    TIPO_PRODOTTO CHAR(1) NOT NULL,  -- 'G' per Gioco, 'C' per Console, 'A' per Accessorio
    ...
    DESCRIZIONE TEXT,
    PRIMARY KEY (ORDER_ID, EMAIL_UTENTE, TIPO_PRODOTTO, ID_PRODOTTO),
    FOREIGN KEY (ORDER_ID, EMAIL_UTENTE) REFERENCES ORDINE(ID, EMAIL_UTENTE)
);
...
INSERT INTO UTENTE (
    EMAIL, NOME, COGNOME, DATA_NASCITA, GENERE, INDIRIZZO,
    CITTA, PROV, CAP, PASSWORD, ADMIN
) VALUES (
    'admin@admin.it', 'Admin', 'User', '1980-01-01', 'M',
    'Via Amministratore 1', 'Emporium City', 'EC', '00000',
    '25f43b1486ad95a1398e3eeb3d83bc4010015fcc9bedb35b432e00298d5021f7', TRUE
);
